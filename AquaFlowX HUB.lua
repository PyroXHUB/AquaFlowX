	...
	local Window = OrionLib:MakeWindow({Name = "PyroX HUB 🔥", HidePremium = true, SaveConfig = true, ConfigFolder = "OrionTest"})
	...
	Tab:AddParagraph("About The HUB","PyroX HUB is a powerful script that enhances your experience in Pet Simulator 99. It offers essential features for efficient gameplay.")
	...
	Name = <string> - The name of the tab.
	Icon = <string> - The icon of the tab.
	PremiumOnly = <bool> - Makes the tab accessible to Sirus Premium users o
	--[[
	Name = <string> - The name of the section.
	]]
